 ...
 */
public class My_order_DetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Picasso.with(My_order_DetailActivity.this).
    ...
    public void loadprofile(String user_id,String auth_token){
        ...
        apiObservable = new ApiObservable();
        getinfo = apiObservable.get_seller_info(user_id, auth_token,getIntent().getStringExtra("item_id"));
                ...
                if (response.isSuccessful()) {
                    try {
                        ...
                        if (respone_code == 200) {
                            ...
                            AlertDialog.Builder dialog = new AlertDialog.Builder( My_order_DetailActivity.this);
                            dialog.setView(view);
                            dialog.show();
