 ...
 */
public class myorder_adpter extends RecyclerView.Adapter<myorder_adpter.ViewHolder>{
    private List<cart_Item_structure> ItemList= new ArrayList<>();
    Context mContext;
    ...
    public myorder_adpter(List<cart_Item_structure> Cart_ItemList, Context mContext, MyAdapterListener onClickListener) {
    ...
    public void notifyDataArray(List<cart_Item_structure> item){
    ...
    public void insert(List<cart_Item_structure> cart_list){
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        if(ItemList.size()!=0) {
            ...
            holder.item_id.setText(ItemList.get(position).getItemId());
